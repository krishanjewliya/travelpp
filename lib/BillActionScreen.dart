...
class BillActionScreen extends StatefulWidget {
  String? id;
  String? trip_id;

  BillActionScreen(this.id, this.trip_id);

  @override
  _BillActionScreenState createState() => _BillActionScreenState();
}

class _BillActionScreenState extends State<BillActionScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          ...
          title: Text('Bill Claim', textAlign: TextAlign.left),
          leading: IconButton(
            icon: const Icon(
  ...
  EditTripDetails() {
    final body = {
      "user_id": sp?.getString(SpUtil.USER_ID.toString()), // "id": "1",
      "trip_id": widget.id,
      //country_id
    };
    {
